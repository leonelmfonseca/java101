package com.leonelfonseca.java.di.wired.autowiredoption.fieldinjection.config;
...
@Configuration
@ComponentScan(
    basePackages = "com.leonelfonseca.java.di.wired.autowiredoption.fieldinjection.component")
