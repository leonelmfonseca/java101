package com.leonelfonseca.java.di.wired.autowiredoption.setterinjection.config;
...
@Configuration
@ComponentScan(
    basePackages = "com.leonelfonseca.java.di.wired.autowiredoption.setterinjection.component")
